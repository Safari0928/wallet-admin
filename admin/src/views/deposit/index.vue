    ...
    <div class="deposit-list">
            ...
            <el-form ref="formRef" class="mb-[-16px]" :model="queryParams" :inline="true">
                ...
                <el-form-item>
                    <el-select v-model="selectedField">
                        ...
                        <el-option label="Card Number" value="cardNumber" />
        ...
        <el-card class="!border-none mt-4" shadow="never">
            ...
            <el-table v-loading="pager.loading" :data="pager.lists" @selection-change="handleSelectionChange">
                ...
                <el-table-column label="Card Number" prop="cardNumber" min-width="160" />
                <el-table-column label="Bank Name" prop="bankName" min-width="120" />
                <el-table-column label="User Id" prop="payId" min-width="120" />
                <el-table-column label="Full Name" prop="fullName" min-width="120" show-overflow-tooltip>
                    <template #default="{ row }">
                        <span style="border: 2px; padding: 2px;">
                            {{ formatName(row.fullName) }}
                        </span>
                    </template>
                </el-table-column>
                ...
                <el-table-column label="status" min-width="160">
                    <template #header>
                        <el-form :model="queryParams" :inline="true" class="mt-4">
                            ...
                            <!-- İstenirse diğer filtreleme öğelerini buraya ekleyebilirsiniz -->
                        </el-form>
...
import { depositList, depositDetail } from '@/api/deposit'
import { usePaging } from '@/hooks/usePaging'
import detailPopup from "./detail.vue";
import { formatTransactionNumber, formatName, formatTimeIfCurrentYear } from '@/utils/filters';
