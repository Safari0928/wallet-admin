    ...
    <div class="deposit-list">
        ...
        <el-card class="!border-none" shadow="never">
            <div class="p-3">
                ...
                <div class="flex justify-between p-3" v-if="!isEditingPayCommission">
                    <span>
                        ...
                        <div class="text-xs font-medium opacity-70">
                            Platform's current handling fee: <strong>{{ data.payCommission }}%</strong>
                        </div>
                    </span>
                ...
                <div class="flex justify-between p-3" v-if="isEditingPayCommission">
                    <span>
                        ...
                        <div class="text-xs font-medium opacity-70">
                            ...
                            <el-input v-model="data.payCommission"></el-input>
                        </div>
                    </span>
                    <div>
                ...
                <!-- Deposit limit for registered users (TRY) -->
                <div class="flex justify-between p-3" v-if="!isEditingUnverifiedUserFee">
                    <span>
                        <div class="font-bold">Deposit limit for registered users (TRY)</div>
                        <div class="text-xs font-medium opacity-70">
                ...
                <hr class="mt-2 opacity-40">
                <!-- Deposit limit for verified users (TRY) -->
                <div class="flex justify-between p-3" v-if="!isEditingVerifiedUserFee">
                    <span>
                        <div class="font-bold">Deposit limit for verified users (TRY)</div>
                        <div class="text-xs font-medium opacity-70">
...
import { configureDeposit, configureDepositUpdate } from '@/api/configure';
...
const fetchData = async () => {
    try {
        const result = await configureDeposit();
        data.value = result;
    } catch (error) {
