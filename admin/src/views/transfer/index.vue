    ...
    <div class="article-lists">
        ...
        <el-card class="!border-none mt-4" shadow="never">
            ...
            <el-table v-loading="pager.loading" :data="pager.lists" @selection-change="handleSelectionChange">
                ...
                <el-table-column label="User Id" prop="payId" min-width="140" />
                ...
                <el-table-column label="Action" width="120" fixed="right">
                    <template #default="{ row }">
                        <el-button type="primary" link @click="handleDetail(row.transferId)">
                            detail
                        </el-button>
                    </template>
                </el-table-column>
...
import { transferList, transferDetail } from '@/api/transfer'
